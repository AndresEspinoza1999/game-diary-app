...
class _DiscoverScreenState extends State<DiscoverScreen> {
  ...
  void _searchGames(String query) async {
    ...
    final rawGames = await _igdbApi.getAllGameVariants(query);
    ...
    final games = await Future.wait(
      rawGames.map((g) async {
        ...
        return Game(
          ...
          summary: g['summary'] ?? '',
          coverUrl: coverUrl,
          platforms: (g['platforms'] as List<dynamic>?)
              ...
              child: game.coverUrl != null
                  ? CachedNetworkImage(
                      ...
                      placeholder: (context, url) =>
                          const SizedBox(width: 80, height: 100, child: Center(child: CircularProgressIndicator())),
                      errorWidget: (context, url, error) =>
                          const SizedBox(width: 80, height: 100, child: Icon(Icons.error)),
                    )
                  : Container(
                      width: 80,
                      height: 100,
